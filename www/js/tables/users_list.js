  ...
  $(function(){
    ...
    DataGridDataSource.prototype = {
      ...
      data: function (options, callback) {
        var url = "required.php?actions=list_users&level=<?php echo $_POST['level'];?>";
        var self = this;
      ...
      $(this).datagrid({
          ...
          formatter: function (items) {
            $.each(items, function (index, item) {
              ...
              item.ID = '<a href="profile.php?ID='+item.ID+'"><i class="fa fa-eye"></i></a>';
            });
          }
      })
      });
